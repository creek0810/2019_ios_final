...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="_019_ios_final",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14_019_ios_final11AppDelegate")
...
@interface AppDelegate (SWIFT_EXTENSION(_019_ios_final)) <UNUserNotificationCenterDelegate>
...
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified chatMenuTable;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified unreadLabel;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC14_019_ios_final19FriendTableViewCell")
...
SWIFT_CLASS("_TtC14_019_ios_final20FriendViewController")
@interface FriendViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified friendTable;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC14_019_ios_final23ImageCollectionViewCell")
...
SWIFT_CLASS("_TtC14_019_ios_final24LeftMessageTableViewCell")
...
SWIFT_CLASS("_TtC14_019_ios_final19LoginViewController")
...
SWIFT_CLASS("_TtC14_019_ios_final11MarginLabel")
...
SWIFT_CLASS("_TtC14_019_ios_final24ProfileUITaTableViewCell")
@interface ProfileUITaTableViewCell : UITableViewCell
...
SWIFT_CLASS("_TtC14_019_ios_final23RightImageTableViewCell")
@interface RightImageTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageButton;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
...
SWIFT_CLASS("_TtC14_019_ios_final25RightMessageTableViewCell")
...
SWIFT_CLASS("_TtC14_019_ios_final27UpdateProfileViewController")
...
SWIFT_CLASS("_TtC14_019_ios_final25UserProfileViewController")
@interface UserProfileViewController : UIViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified propic;
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified profileTable;
- (IBAction)changeImage:(id _Nonnull)sender;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (void)imagePickerController:(UIImagePickerController * _Nonnull)picker didFinishPickingMediaWithInfo:(NSDictionary<UIImagePickerControllerInfoKey, id> * _Nonnull)info;
...
SWIFT_CLASS("_TtC14_019_ios_final24WeatherMenuTableViewCell")
@interface WeatherMenuTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified nameLabel;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
...
SWIFT_CLASS("_TtC14_019_ios_final25WeatherMenuViewController")
@interface WeatherMenuViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC14_019_ios_final21WeatherViewController")
@interface WeatherViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified weatherTable;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
